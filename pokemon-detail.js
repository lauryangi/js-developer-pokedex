    ...
    try{
            ...
            if (currentPokemonId === id) {
                displayPokemonDetails(pokemon);
                    ...
                    document.querySelector(".body3-fonst.pokemon-description").textContent = flavorText;
                    ...
                    if(id !== 151) {
                        rightArrowArrow.addEventListener("click", () => {
                            navigatePokemon(id + 1);
                        });
                    }

                    window.history.pushStaate({}, "", `./detail.html?id=${id}`);
        ...
        console.error("An error ocured while fetching Pokemon data:", error);
        return false;
    }
}
